...
NS_SWIFT_NAME(Smartlook.RecordingMaskElementType)
typedef NS_ENUM(NSUInteger, SLRecordingMaskElementType) {
    SLRecordingMaskElementTypeSolid,
    SLRecordingMaskElementTypeCut
};

NS_SWIFT_NAME(Smartlook.RecordingMaskElement)
@interface SLRecordingMaskElement : NSObject
@property (nonatomic) SLRecordingMaskElementType type;
@property (nonatomic) CGRect rect;

-(instancetype _Nonnull )initWithRect:(CGRect)rect;
+(SLRecordingMaskElement *_Nonnull)elementWithRect:(CGRect)rect;

-(instancetype _Nonnull )initWithRect:(CGRect)rect ofType:(SLRecordingMaskElementType)type;
+(SLRecordingMaskElement *_Nonnull)elementWithRect:(CGRect)rect ofType:(SLRecordingMaskElementType)type;

@end

NS_SWIFT_NAME(Smartlook.RecordingMask)
typedef NSArray<SLRecordingMaskElement *> SLRecordingMask;
...
+ (void)setRecordingMask:(SLRecordingMask *_Nullable)recordingMask;
+ (SLRecordingMask *_Nonnull)currentRecordingMask;
